%
% HOLP.tex
% Main LaTeX document for formatting HOLP
%
...
%%% HOLP PAGE STYLE %%%
\makepagestyle{holpstyle}
\pagestyle{holpstyle}
\makeevenhead{holpstyle}{}{\hspace{2em}\itshape\small\leftmark}{}
\makeoddhead{holpstyle}{}{\scshape\small\rightmark}{}
\makeevenfoot{holpstyle}{}{\hspace{2em}\thepage}{}
\makeoddfoot{holpstyle}{}{\thepage}{}
%%% END HOLP PAGE STYLE %%%

%%% HOLPSKI CHAPTER STYLE %%%
\makechapterstyle{holpski}{%
...
%%% CHAPTER STYLE %%%
\chapterstyle{holpski} % defined in preamble
\def\topblockvspace{0.11}
%%% END CHAPTER STYLE %%%

%%% CHAPTER CONFIG %%%
\newcommand{\chapterheader}{History of LulzBot Printers}
...
\chapterconf{Introduction}{Introduction}{HOLP}
...
\chapterconf{Mars}{Prusa Bootstrap}{Mars}
\chapterconf{Clonedel}{LulzBot Clonedel}{Repstrap}
\chapterconf{Prusa}{LulzBot Prusa 1.0, 2.0}{Mustaches, Monocles, \& Other Sundry Items}
\chapterconf{AO}{LulzBot AO-100, AO-101}{Print More}
\chapterconf{TAZ}{LulzBot TAZ 1, 2, 3, 4, 5}{Print Big}
\chapterconf{Mini}{LulzBot Mini}{Get Easy}
\chapterconf{Cluster}{3D Printer Cluster}{Moar Means Moar}
